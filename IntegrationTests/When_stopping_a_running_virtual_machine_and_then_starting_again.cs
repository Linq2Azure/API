...
{
    [TestClass]
    public class When_stopping_a_running_virtual_machine_and_then_starting_again : VirtualMachineSetup
    {

        private readonly string _windowsmachine = "Win" + Guid.NewGuid().ToString().Replace("-", String.Empty).Substring(0, 10);

        [TestMethod]
        public void It_should_restart_the_virtual_machine()
        {
